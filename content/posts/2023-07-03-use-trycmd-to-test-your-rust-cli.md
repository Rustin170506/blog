...
1. [Use `cargo new` to create a new CLI.](https://github.com/0xPoe/trycmd-example/commit/ead3a18e2502f23ee856fe1d3fca8109b6e867cb)

    ```sh
    cargo new --bin trycmd-example
    ```

2. [Add clap as a dependency with `derive` feature.](https://github.com/0xPoe/trycmd-example/commit/a7b10c45ad04b2c2667d5c7c2b48e659018eb9a9)
...
3. [Add a simple CLI.](https://github.com/0xPoe/trycmd-example/commit/a9a227147b7918d7caa48c86095494f39a716d5d)
...
2. [Create a `tests/cmd/help.toml` file.](https://github.com/0xPoe/trycmd-example/commit/3af3e458b2f6e2316843a43aae6e28aff9c671bf)
...
3. [Add `trycmd` as a dev dependency.](https://github.com/0xPoe/trycmd-example/commit/9c17c3d3ce756a00969cd0f72d92372dda930593)
...
4. [Add a Rust test case.](https://github.com/0xPoe/trycmd-example/commit/570561be3c96d6ce2e673836719a31e2bd51346d)
...
### [Overwrite the output](https://github.com/0xPoe/trycmd-example/commit/6c8123d456c4c6333e1986db2fc7bf80d62f5cc9)
...
1. [Create a README.md file.](https://github.com/0xPoe/trycmd-example/commit/c8375173cbad8987f33f6c12ad9f0bb6fb4a85a8)
...
2. [Add README.md as a test case.](https://github.com/0xPoe/trycmd-example/commit/c7489852927e52efa6e4b7a805628d13e7bf1c55)
...
4. [Overwrite the output.](https://github.com/0xPoe/trycmd-example/commit/80c3c9bad811bd11933935421c8f80b65ba74c17)
...
1. [Change the `main.rs` file.](https://github.com/0xPoe/trycmd-example/commit/900cddd1ebedc3932f2bf6d7c3e98b60182b5976)
...
2. [Add a new TOML test case.](https://github.com/0xPoe/trycmd-example/commit/d52071fe1d93c00c84a42a5fae68776d726c30a7)
...
3. [Add an output directory and an output file.](https://github.com/0xPoe/trycmd-example/commit/92ca6c26f1f10a48a0df5ca5dbb6c9b477540bec)
...
5. [Overwrite the output.](https://github.com/0xPoe/trycmd-example/commit/ecc694e73d0946bda0d5e65925dc6912ab3dee69)
...
You can find the source code of this tutorial in [this repository](https://github.com/0xPoe/trycmd-example).
